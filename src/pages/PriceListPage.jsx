...
const PriceListPage = () => {
    ...
    const individualWorkbooks = useMemo(() => [
        ...
        <div className="pt-24 md:pt-48 min-h-screen bg-[#f8f9fb] pb-16 md:pb-32 animate-in fade-in duration-700">
            <div className="max-w-7xl mx-auto px-4 md:px-12 lg:px-20">
                ...
                <div className="text-center mb-12 md:mb-24 relative">
                    ...
                    <p className="text-gray-400 font-bold uppercase text-[10px] md:text-[11px] tracking-widest max-w-xs md:max-w-none mx-auto">Effective and standard pricing for Enlight e-Learning Series</p>
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#01A651]/10 rounded-full blur-3xl -z-10"></div>
                </div>

                {/* 1. Course Books Table */}
                <div className="bg-white rounded-[24px] md:rounded-[50px] shadow-2xl border border-gray-100 p-6 md:p-16 mb-12 md:mb-24 overflow-hidden relative">
                    <div className="absolute top-0 left-0 w-full h-2 bg-[#EC1C24]"></div>
                    <h2 className="text-xl md:text-3xl font-black text-[#231F20] uppercase tracking-tighter mb-8 md:mb-12 flex items-center gap-4 text-left">
                        ...
                        <table className="w-full text-left border-collapse min-w-[800px]">
                            <thead>
                                <tr className="border-b-2 border-gray-100">
                                    <th className="py-4 md:py-6 pr-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-400">Subject</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#EC1C24]">Pre-KG</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#EC1C24]">Jr.KG</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#EC1C24]">Sr.KG</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#01A651]">1st</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#01A651]">2nd</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#01A651]">3rd</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#01A651]">4th</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#01A651]">5th</th>
                                </tr>
                            </thead>
                    ...
                    <div className="mt-6 md:hidden text-[9px] font-black uppercase text-gray-300 text-center tracking-widest">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-24">
                    {/* 2. Semester Books */}
                    <div className="bg-white rounded-[24px] md:rounded-[40px] shadow-xl border border-gray-100 p-8 md:p-12 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#2E3092]/5 rounded-full -translate-y-10 translate-x-10"></div>
                        <h2 className="text-lg md:text-2xl font-black text-[#231F20] uppercase tracking-tighter mb-8 md:mb-10 flex items-center gap-4 text-left">
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-gray-100">
                                    <th className="py-3 text-[9px] font-black uppercase text-gray-400">Class</th>
                                    <th className="py-3 text-[9px] font-black uppercase text-[#EC1C24]">Coursebook</th>
                                    <th className="py-3 text-[9px] font-black uppercase text-[#01A651]">Workbook</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-50">
                ...
                <div className="bg-[#231F20] rounded-[32px] md:rounded-[50px] shadow-2xl p-8 md:p-16 text-white overflow-hidden relative mb-12 md:mb-24">
                    <div className="absolute bottom-0 right-0 w-64 h-64 bg-[#EC1C24]/10 rounded-full blur-3xl"></div>
                    <h2 className="text-xl md:text-3xl font-black uppercase tracking-tighter mb-10 md:mb-12 flex items-center gap-4 text-left">
                        ...
                        <table className="w-full text-left border-collapse min-w-[600px]">
                            <thead>
                                <tr className="border-b border-white/10">
                                    <th className="py-4 md:py-6 pr-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-white/40">Subject</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#FFF200]">Sr.KG</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#FFF200]">1st</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#FFF200]">2nd</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#FFF200]">3rd</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#FFF200]">4th</th>
                                    <th className="py-4 md:py-6 px-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#FFF200]">5th</th>
                                </tr>
                            </thead>
                ...
                {/* Call to Action */}
                <div className="text-center bg-white rounded-[40px] md:rounded-[60px] p-8 md:p-20 shadow-2xl border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 mb-16">
